          ...
          <div class="col-lg-4">
            <div class="card card-details card-right">
              ...
              <div class="members my-2">
                <img src="{{ url('frontend/images/avatar-2.png')}}" class="mr-1 member-image">
                <img src="{{ url('frontend/images/avatar-3.png')}}" class="mr-1 member-image">
                <img src="{{ url('frontend/images/avatar-2.png')}}" class="mr-1 member-image">
                <img src="{{ url('frontend/images/avatar-3.png')}}" class="mr-1 member-image">
              </div>
            ...
            <div class="join-container">
              @auth
                <form action="{{ route('checkout_process', $item->id) }}" method="post">
                    @csrf
                    <button class="btn btn-block btn-join-now mt-3 py-2" type="submit">Join Npw</button>
                </form>
              @endauth
              @guest
              <a href="{{ route('login') }}" class="btn btn-block btn-join-now mt-3 py-2">Login</a>
              @endguest
            </div>
          </div>
        </div>
