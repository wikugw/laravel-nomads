          ...
          <![endif]-->
                            <div class="mj-column-per-100 mj-outlook-group-fix"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center"
                                            style="font-size:0px;padding:25px 30px;word-break:break-word;">
                                            <div
                                        ...
                                        <tr>
                                            <td
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    ...
                                                    <tr>
                                                        <td align="left"
                                                            style="font-size:0px;padding:0 30px ;word-break:break-word;">
                                                            <div
                                                    ...
                                                    <tr>
                                                        <td align="left"
                                                            style="font-size:0px;padding:20px 30px 0;word-break:break-word;">
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td align="center" bgcolor="#ff9e53"
                                                                        ...
                                                                        valign="middle">
                                                                        <a href="{{ url('checkout/' . $data->id) }}" target="_blank"
          ...
          <![endif]-->
                            <div class="mj-column-per-100 mj-outlook-group-fix"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:0 30px ;word-break:break-word;">
                                            <div
                                                style="font-family:Assistant, Helvetica, Arial, Sans-serif;font-size:18px;line-height:20px;text-align:left;color:#071c4d;">
                                                Butuh Bantuan?</div>
                                        </td>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                ...
                                                <tr>
                                                    <td style="width:50px">
                                                        <img width="50px" src="{{ url('frontend/images/ic_support.png') }}" />
                                                    </td>
                                                    <td style="font-size: 18px;
          padding-left:10px;
          color: #071c4d;
          font-family: Assistant, Helvetica, Arial, sans-serif"> supprt@nomads.id <br> 082142708804 </td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
